...
<html lang="en">
  <head>
    ...
    <title>DATA INVENTORY NNCC ! | </title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo site_url('Home/index');?>" class="site_title"><i class="fa fa-paw"></i> <span>Data Inventory</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo site_url('Home/table_perangkat');?>"><i class="fa fa-table"></i> Perangkat </a></li>
                </ul>
              </div>
