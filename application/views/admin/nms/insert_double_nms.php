...
<html lang="en">
  ...
  <head>
    ...
    <!-- Dropzone.js -->
    <link href="<?php echo base_url('asset/admin/vendors/dropzone/dist/min/dropzone.min.css')?>" rel="stylesheet">
  ...
  <body class="nav-md">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <br />
                    <a href="<?php echo site_url('Home/table_nms')?>"><button type="submit" class="btn btn-primary">Submit</button></a>
    ...
    <!-- Dropzone.js -->
    <script src="<?php echo base_url('asset/admin/vendors/dropzone/dist/min/dropzone.min.js')?>"></script>
